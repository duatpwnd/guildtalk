	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://duatpwnd.herokuapp.com/yo/nse_files/quick_photo_uploader/popup/FileUploader.php',	//샘플 URL입니다.
 	        sCallback : 'http://duatpwnd.herokuapp.com/yo/nse_files/quick_photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
